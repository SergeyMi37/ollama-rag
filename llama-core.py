...
prompt  = "Используя исходные документы, выбери номер темы, который больше всего" \
 "подходит для текста: 'Отсутствует водоснабжение'." \
 "Ответ предоставь только числом номера темы." 
